          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full mb-6">
                <Sparkle className="size-4 text-yellow-400" weight="fill" />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 gap-4 auto-rows-[160px]">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="md:col-span-6 lg:col-span-8 row-span-2 bg-gray-950 text-white p-8 relative overflow-hidden group"
            >
              <div className="relative z-10 h-full flex flex-col justify-between">
                <div>
                  <div className="size-14 bg-white/10 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                    <Storefront className="size-7 text-white" weight="bold" />
                  </div>
            ...
            >
              <div className="flex items-center gap-4 mb-3">
                <div className="size-10 bg-gray-950 flex items-center justify-center group-hover:scale-110 transition-transform">
                  <ChartLineUp className="size-5 text-white" weight="bold" />
                </div>
              ...
              <div className="flex items-end gap-1 h-10">
                {[40, 65, 45, 80, 55, 90, 70, 85].map((h, i) => (
                  <div
                    key={`bar-${h}`}
                    className="flex-1 bg-gray-950 rounded-t"
            ...
            <motion.div
              ...
              className="md:col-span-3 lg:col-span-4 row-span-2 bg-gray-950 text-white p-8 relative overflow-hidden group"
            >
              <div className="h-full flex flex-col justify-between">
                <div>
                  <div className="size-12 bg-white/10 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                    <Lightning className="size-6 text-white" weight="bold" />
                  </div>
            ...
            >
              <div className="flex items-center gap-4">
                <div className="size-10 bg-gray-950 flex items-center justify-center group-hover:scale-110 transition-transform relative">
                  <Broadcast className="size-5 text-white" weight="bold" />
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="size-10 bg-gray-950 flex items-center justify-center group-hover:scale-110 transition-transform">
                    <Heart className="size-5 text-white" weight="bold" />
                  </div>
                  <div>
                ...
                <div className="flex -space-x-2">
                  {[...Array(4)].map((_, i) => (
                    <div key={i} className="size-8 rounded-full bg-gray-300 border-2 border-gray-100 flex items-center justify-center text-xs font-medium">
            ...
            <motion.div
              ...
              className="md:col-span-6 lg:col-span-8 row-span-1 bg-gray-950 text-white p-6 relative overflow-hidden group"
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="size-12 bg-white/10 flex items-center justify-center group-hover:scale-110 transition-transform">
                    <Crown className="size-6 text-white" weight="bold" />
                  </div>
                  <div>
            ...
            >
              <div className="flex items-center gap-4">
                <div className="size-10 bg-gray-950 flex items-center justify-center group-hover:scale-110 transition-transform">
                  <Star className="size-5 text-white" weight="bold" />
                </div>
                <div>
          ...
          <div className="relative">
            ...
            <div className="space-y-16">
              ...
              >
                ...
                <div className="absolute left-8 md:left-1/2 -translate-x-1/2 size-16 bg-gray-950 text-white flex items-center justify-center text-xl font-bold z-10">
                  1
                </div>
                <div className="pl-24 md:pl-0 md:w-1/2 md:text-left">
                  ...
                  <div className="bg-white p-4 border border-gray-200 inline-flex items-center gap-3">
                    <Users className="size-6" weight="bold" />
              ...
              >
                <div className="hidden md:block md:w-1/2 text-right pr-16">
                  <div className="bg-white p-4 border border-gray-200 inline-flex items-center gap-3">
                    <CheckCircle className="size-6" weight="bold" />
              ...
              >
                <div className="hidden md:block md:w-1/2 text-right pr-16">
                  <div className="bg-gray-950 text-white p-4 inline-block">
                ...
                <div className="pl-24 md:pl-16 md:w-1/2">
                  ...
                  <div className="md:hidden mt-4 bg-gray-950 text-white p-4 inline-block">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {TIER_BENEFITS.map((tier, i) => (
              ...
              >
                ...
                <div className={`size-12 rounded-full bg-gradient-to-br ${tier.color} flex items-center justify-center mb-4`}>
                  <Crown className="size-6 text-white" weight="fill" />
                </div>
                ...
                <ul className="space-y-3">
                  {tier.benefits.map((benefit) => (
                    <li key={benefit} className="flex items-start gap-2 text-sm">
                      <CheckCircle className="size-4 text-green-500 mt-0.5 flex-shrink-0" weight="fill" />
                      <span>{benefit}</span>
                    </li>
                  ))}
                </ul>
              ...
              >
                <div className="flex gap-1 mb-4">
                  {Array.from({ length: 5 }, (_, i) => i + 1).map((star) => (
                    <Star key={`${testimonial.name}-star-${star}`} className="size-4 text-yellow-400" weight="fill" />
                  ))}
                </div>
                <p className="text-gray-600 mb-6 italic">&ldquo;{testimonial.quote}&rdquo;</p>
                <div className="flex items-center gap-4">
                  <div className="relative size-12 rounded-full overflow-hidden bg-gray-100">
                    <Image
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            {[
              ...
              { icon: TiktokLogo, name: "TikTok", color: "from-gray-950 to-gray-800" },
              ...
              >
                <div className={`size-24 bg-gradient-to-br ${platform.color} rounded-2xl flex items-center justify-center shadow-lg`}>
                  <platform.icon className="size-12 text-white" weight="fill" />
                </div>
...
export const Route = createFileRoute("/creators/")({ component: CreatorsLandingPage });

...
function CreatorApplyPage() {
  ...
  useEffect(() => {
    if (!authLoading && !user) {
      push("/login?redirect=/creators/apply");
    }
  ...
  if (alreadyCreator) {
    return (
      <div className="min-h-screen bg-white flex flex-col items-center justify-center px-6">
        ...
        <Link
          href="/creator"
          className="flex items-center gap-2 px-8 py-3 bg-gray-950 text-white text-sm hover:bg-gray-800 transition"
        >
          Go to Dashboard
  ...
  if (pendingApplication) {
    return (
      <div className="min-h-screen bg-white flex flex-col items-center justify-center px-6">
        <div className="size-16 bg-amber-100 rounded-full flex items-center justify-center mb-6">
          <SpinnerGap className="size-8 text-amber-600" />
        </div>
    ...
    return (
      <div className="min-h-screen bg-white flex flex-col items-center justify-center px-6">
        <motion.div
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
          className="size-16 bg-green-100 rounded-full flex items-center justify-center mb-6"
        >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              >
                <div className="size-14 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <label htmlFor="page-field-29" className="block text-sm font-medium mb-2">
                  Full Name <span className="text-red-500">*</span>
                </label>
                <input id="page-field-29"
              ...
              <div>
                <label htmlFor="page-field-30" className="block text-sm font-medium mb-2">
                  Username <span className="text-red-500">*</span>
                </label>
                <div className="relative">
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400">@</span>
                  <input id="page-field-30"
                    aria-label="Username"
                    type="text"
            ...
            <div>
              <label htmlFor="page-field-31" className="block text-sm font-medium mb-2">
                Bio <span className="text-red-500">*</span>
              </label>
              <textarea id="page-field-31"
                aria-label="Bio"
                value={formData.bio}
            ...
            <div>
              <label htmlFor="page-field-5" className="block text-sm font-medium mb-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <InstagramLogo className="size-5 text-pink-500" />
                  <input
                ...
                <div className="flex items-center gap-3">
                  <TiktokLogo className="size-5 text-black" />
                  <input
                ...
                <div className="flex items-center gap-3">
                  <YoutubeLogo className="size-5 text-red-500" />
                  <input
            ...
            <div>
              <label htmlFor="page-field-32" className="block text-sm font-medium mb-2">
                Total Follower Count
              </label>
              <input id="page-field-32"
                aria-label="Total follower count"
                type="number"
            ...
            <div>
              <label htmlFor="page-field-33" className="block text-sm font-medium mb-2">
                Why do you want to join?
              </label>
              <textarea id="page-field-33"
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full py-4 bg-gray-950 text-white font-medium hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed transition flex items-center justify-center gap-2"
            >
              {submitting ? (
                <>
                  <SpinnerGap className="size-5 animate-spin" />Submitting…</>
              ) : (
                <>
                  Submit Application
                  <ArrowRight className="size-4" />
...
export const Route = createFileRoute("/creators/apply")({ component: CreatorApplyPage });

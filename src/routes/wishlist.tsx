  ...
  if (wishlist.length === 0) {
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center text-center px-4">
        ...
        >
          <div className="size-20 border border-gray-200 flex items-center justify-center mx-auto mb-6">
          ...
          <Link 
            href="/shop" 
            className="inline-flex items-center gap-3 bg-gray-950 text-white px-10 py-4 text-sm tracking-wider font-medium hover:bg-gray-900 transition"
          >
            START SHOPPING
                  ...
                  <div className="relative aspect-[3/4] mb-4 overflow-hidden bg-gray-100">
                    ...
                    <div className="absolute top-3 right-3 flex flex-col gap-2">
                      <button type="button" onClick={(e) => {
                        ...
                        className="size-10 bg-white flex items-center justify-center shadow-md hover:bg-red-50 transition"
                    ...
                    <button type="button" onClick={(e) => {
                      ...
                      className="absolute bottom-4 left-4 right-4 bg-white text-black py-3 text-sm tracking-wider font-medium opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 hover:bg-gray-950 hover:text-white flex items-center justify-center gap-2"
                    >

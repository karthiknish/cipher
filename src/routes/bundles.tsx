  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[4/3] bg-gray-100 overflow-hidden">
        ...
        {/* Discount Badge */}
        <div className="absolute top-4 left-4 bg-gray-950 text-white px-3 py-1.5 flex items-center gap-1.5">
        ...
        <div className="absolute bottom-4 left-4 right-4 flex gap-2">
          ...
          {bundle.products.length > 3 && (
            <div className="w-12 h-16 bg-gray-950 text-white flex items-center justify-center text-xs font-medium shadow-lg">
              +{bundle.products.length - 3}
            </div>
          )}
        </div>
        ...
        <div className="flex gap-3">
          <button type="button" onClick={handleAddBundle}
            ...
            {isAdding ? (
              ...
              <>
                <ShoppingBag className="size-4" /> ADD BUNDLE
              </>
            )}
          </button>
          <Link 
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="py-8">
                ...
                <Link 
                  ...
                  className="inline-flex items-center gap-2 bg-gray-950 text-white px-8 py-4 text-sm tracking-wider font-medium hover:bg-gray-900 transition"
                >
                  SHOP THIS BUNDLE <ArrowRight className="size-4" />
                </Link>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              <div className="size-16 bg-white border border-gray-200 flex items-center justify-center mx-auto mb-4">

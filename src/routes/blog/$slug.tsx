      ...
      <article className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="flex items-center justify-between py-6 mb-12 border-y border-gray-200">
          <div className="flex items-center gap-6">
            <button type="button" onClick={handleLike}
              ...
              <Heart className={`size-6 ${hasLiked ? "fill-current" : ""}`} weight={hasLiked ? "fill" : "regular"} />
          ...
          <div className="relative">
            <button aria-label="share network" type="button" onClick={() => setShowShareMenu(!showShareMenu)}
            ...
            {showShareMenu && (
              <div className="absolute right-0 top-full mt-2 bg-white border border-gray-200 shadow-lg z-10">
                <button aria-label="x logo" type="button" onClick={() => handleShare("twitter")}
                  className="flex items-center gap-3 w-full px-4 py-3 hover:bg-gray-50 transition"
                >
                  <XLogo className="size-4" />
                  <span className="text-sm">Twitter</span>
                </button>
                <button aria-label="facebook logo" type="button" onClick={() => handleShare("facebook")}
                  className="flex items-center gap-3 w-full px-4 py-3 hover:bg-gray-50 transition"
                >
                  <FacebookLogo className="size-4" />
                  <span className="text-sm">Facebook</span>
                </button>
                <button aria-label="linkedin logo" type="button" onClick={() => handleShare("linkedin")}
                  className="flex items-center gap-3 w-full px-4 py-3 hover:bg-gray-50 transition"
                >
                  <LinkedinLogo className="size-4" />
                  <span className="text-sm">LinkedIn</span>
                </button>
                <button aria-label="link icon" type="button" onClick={() => handleShare("copy")}
        ...
        <div className="bg-gray-50 p-8 mb-16">
          <div className="flex items-start gap-6">
            {post.author.avatar && (
              <div className="relative size-20 rounded-full overflow-hidden flex-shrink-0">
                <Image
                  src={post.author.avatar}
                  alt={post.author.name}
                  fill

  ...
  return (
    <div className="border-b border-gray-200">
      ...
      >
        ...
        >
          <CaretDown className="size-5 flex-shrink-0" />
        </motion.div>
      </button>
      <AnimatePresence>
        {isOpen && (
      ...
      <section className="py-16 md:py-24 bg-neutral-50">
        <div className="w-full px-6 md:px-12">
          ...
          >
            ...
            <Link
              href="/contact"
              className="inline-block bg-gray-950 text-white px-10 py-4 text-sm tracking-wider font-medium hover:bg-gray-900 transition"
            >
              CONTACT US
            </Link>
          </motion.div>

  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gray-950 text-white py-20 md:py-28">
        ...
        {/* Decorative corner */}
        <div className="absolute bottom-0 right-0 size-48 bg-gradient-to-tl from-white/5 to-transparent" />
      </section>
      ...
      <section className="sticky top-16 z-20 bg-white border-b border-gray-100">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-4 gap-4 overflow-x-auto">
            ...
            {/* View Toggle & Stores */}
            <div className="flex items-center gap-2">
              <button type="button" onClick={() => setShowStores(!showStores)}
              ...
              <div className="flex border border-gray-200">
                <button aria-label="squares four" type="button" onClick={() => setViewType("grid")}
                  className={`p-2 transition ${viewType === "grid" ? "bg-gray-950 text-white" : "hover:bg-gray-100"}`}
                >
                  <SquaresFour className="size-5" />
                </button>
                <button aria-label="list" type="button" onClick={() => setViewType("list")}
                  className={`p-2 transition ${viewType === "list" ? "bg-gray-950 text-white" : "hover:bg-gray-100"}`}
                >
            ...
            >
              ...
              {activeFilter === "nearby" && !userLocation?.enabled && (
                <div className="bg-gray-50 p-8 text-center mb-8">
                  <MapTrifold className="size-12 text-gray-400 mx-auto mb-4" />
      ...
      <section className="bg-gray-950 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            ...
            />
            <button type="button" className="px-8 py-3 bg-white text-black text-sm tracking-wider font-medium hover:bg-gray-100 transition">
              SUBSCRIBE
            </button>
          </div>
        </div>

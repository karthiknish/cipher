...
import { NewProductHeader, NewProductFooter } from "@/components/admin-product-new";
...
export const Route = createFileRoute("/admin/products/new")({ component: NewProductPage });

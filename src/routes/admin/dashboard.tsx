...
import { DateRange, Metrics, CustomerData, InventoryForecastItem } from "@/components/admin-layout";
import { DashboardTab } from "@/components/admin-layout/DashboardTab";
...
function DashboardPageContent() {
  ...
  const metrics: Metrics = useMemo(() => {
    ...
    const recentOrders = allOrders
      .toSorted((a, b) => getOrderTime(b) - getOrderTime(a))
      .slice(0, 5);

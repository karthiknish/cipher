...
function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const supportEmail = "hello@cipherstreet.com";
    const subject = encodeURIComponent(
      `[Contact] ${formData.subject || "General"} — ${formData.name}`
    );
    ...
    toast.info("Your email app should open — send the message from there.");
  };
          ...
          >
            {isSubmitted ? (
              <div className="bg-neutral-50 p-12 text-center">
                <div className="size-16 border border-black mx-auto mb-6 flex items-center justify-center">
                  <Check className="size-8" />
                </div>
                <h2 className="text-2xl font-light tracking-tight mb-4">OPEN YOUR EMAIL APP</h2>
                <p className="text-gray-500 mb-8">
                  We opened a draft to hello@cipherstreet.com. Send it from your mail app and we will reply within 24–48 hours.
                </p>
              ...
              <>
              <p className="text-sm text-gray-500 mb-6 border-l-2 border-black pl-4">
                Submitting opens your email client with a pre-filled message to our team (no backend inbox yet).
              </p>
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="contact-name" className="block text-xs tracking-wider text-gray-500 mb-3">
                      YOUR NAME
                    </label>
                  ...
                  <div>
                    <label htmlFor="contact-email" className="block text-xs tracking-wider text-gray-500 mb-3">
                      EMAIL ADDRESS
                    </label>
                ...
                <div>
                  <label htmlFor="contact-subject" className="block text-xs tracking-wider text-gray-500 mb-3">
                    SUBJECT
                  </label>
                ...
                <div>
                  <label htmlFor="contact-message" className="block text-xs tracking-wider text-gray-500 mb-3">
                    MESSAGE
                  </label>
                ...
                <button
                  ...
                  className="group inline-flex items-center gap-3 bg-gray-950 text-white px-10 py-4 text-sm tracking-wider font-medium hover:bg-gray-900 transition disabled:opacity-50"
                >
                  {isSubmitting ? (
                    <>
                      <SpinnerGap className="size-4 animate-spin" /> SENDING
                    </>
                  ) : (
                    <>
                      SEND MESSAGE
            ...
            <div>
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  <Envelope className="size-5 mt-0.5" />
                  <div>

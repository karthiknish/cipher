...
const RARITY_CONFIG: Record<BadgeRarity, { label: string; border: string; bg: string }> = {
  ...
  legendary: { label: "Legendary", border: "border-black", bg: "bg-gray-950" },
};
...
function BadgeCard({
  ...
  return (
    ...
    >
      {/* New indicator */}
      {isNew && (
        <div className="absolute -top-2 -right-2 bg-gray-950 text-white px-2 py-0.5 text-xs">
          NEW
        </div>
      )}
        ...
        <div className="p-6 border-b border-gray-200 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="px-2 py-0.5 text-xs bg-gray-100 flex items-center gap-1">
              <categoryConfig.icon className="size-3" />
      ...
      <div className="divide-y divide-gray-100">
        {leaderboard.map((entry, index) => (
          <div key={entry.userId} className="p-4 flex items-center gap-4">
            <div className={`size-8 flex items-center justify-center text-sm font-bold ${
      ...
      {userAchievements && (
        <div className="p-4 bg-gray-50 border-t border-gray-200">
          <div className="flex items-center gap-4">
            <div className="size-8 flex items-center justify-center text-sm font-bold bg-gray-950 text-white">
            ...
            <div className="bg-white border border-gray-200 p-6">
              ...
              <ul className="space-y-3 text-sm">
                <li className="flex items-start gap-2">
                  <Gift className="size-4 mt-0.5 text-gray-400" />
                  <span>Make purchases and build your collection</span>
                </li>
                <li className="flex items-start gap-2">
                  <Star className="size-4 mt-0.5 text-gray-400" />
                  <span>Write reviews and engage with products</span>
                </li>
                <li className="flex items-start gap-2">
                  <Users className="size-4 mt-0.5 text-gray-400" />
                  <span>Refer friends and grow the community</span>
                </li>
                <li className="flex items-start gap-2">
                  <Fire className="size-4 mt-0.5 text-gray-400" />
                  <span>Maintain visit streaks</span>
                </li>
                <li className="flex items-start gap-2">
                  <Trophy className="size-4 mt-0.5 text-gray-400" />

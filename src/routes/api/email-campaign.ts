  ...
  "win-back": {
    ...
    getContent: (data) => `
      <div style="font-family: 'Helvetica Neue', sans-serif; max-width: 600px; margin: 0 auto; padding: 40px 20px;">
        ...
        <a href="${import.meta.env.VITE_SITE_URL || 'https://cipher-omega-three.vercel.app'}/shop" 
  ...
  "vip-exclusive": {
    ...
    getContent: (data) => `
      <div style="font-family: 'Helvetica Neue', sans-serif; max-width: 600px; margin: 0 auto; padding: 40px 20px;">
        ...
        <a href="${import.meta.env.VITE_SITE_URL || 'https://cipher-omega-three.vercel.app'}/shop?collection=new" 
  ...
  "cart-abandonment": {
    ...
    getContent: (data) => `
      <div style="font-family: 'Helvetica Neue', sans-serif; max-width: 600px; margin: 0 auto; padding: 40px 20px;">
        ...
        <a href="${import.meta.env.VITE_SITE_URL || 'https://cipher-omega-three.vercel.app'}/cart" 
           style="display: inline-block; background: #000; color: #fff; padding: 16px 40px; text-decoration: none; font-size: 12px; letter-spacing: 2px;">
          COMPLETE PURCHASE
        </a>
      </div>
...
export const Route = createFileRoute("/api/email-campaign")({
  server: {
    handlers: {

  ...
  if (authLoading || (!currentInfluencer && user)) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="animate-spin rounded-full size-8 border-b-2 border-black" />
      </div>
    );
  }
  ...
  if (!currentInfluencer) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-6">
        ...
        <Link
          href="/creators/apply"
          className="px-8 py-3 bg-gray-950 text-white text-sm hover:bg-gray-800 transition"
        >
          Apply Now
        </Link>
      </div>
      ...
      <AnimatePresence>
        {showProductPicker && (
          <motion.div
            ...
            role="presentation"
          ><button type="button" aria-label="Close" className="absolute inset-0 w-full h-full cursor-default" onClick={() => setShowProductPicker(false)} />
            <motion.div
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="size-12 rounded-full overflow-hidden bg-gray-200">
                {currentInfluencer.avatar ? (
                  ...
                  <div className="size-full bg-gradient-to-br from-gray-300 to-gray-400 flex items-center justify-center text-white font-bold">
            ...
            <Link
              ...
              className="flex items-center gap-2 px-4 py-2 bg-gray-950 text-white text-sm rounded-lg hover:bg-gray-800 transition"
            >
              View Storefront
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-white rounded-xl p-6 border">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Percent className="size-5 text-gray-400" />
                </div>
            ...
            <div className="bg-white rounded-xl border overflow-hidden">
              <div className="p-4 border-b flex items-center justify-between">
                ...
                <button type="button" onClick={() => setActiveTab("earnings")}
            ...
            <div className="bg-white rounded-xl border overflow-hidden">
              <div className="p-4 border-b flex items-center justify-between">
                ...
                <button type="button" onClick={() => {
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-gray-950 text-white text-sm rounded-lg hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed transition"
                >
                        ...
                        <div key={productId} className="group relative">
                          <div className="relative aspect-[4/5] rounded-lg overflow-hidden bg-gray-100">
                            <Image
                              ...
                              className="object-cover"
                             sizes="(max-width: 768px) 100vw, 50vw" />
                            <button aria-label="trash" type="button" onClick={() => handleRemoveProduct(productId, "featured")}
                        ...
                        <div key={productId} className="group relative">
                          <div className="relative aspect-[4/5] rounded-lg overflow-hidden bg-gray-100">
                            <Image
                              ...
                              className="object-cover"
                             sizes="(max-width: 768px) 100vw, 50vw" />
                            <button aria-label="trash" type="button" onClick={() => handleRemoveProduct(productId, "curated")}
                              className="absolute top-2 right-2 p-2 bg-white rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition-opacity"
                            >
                              <Trash className="size-4 text-red-500" />
                            </button>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl p-6 border">
              ...
              <div className="space-y-4">
                <div>
                  <label htmlFor="page-storefront-url-27" className="text-sm text-gray-500 block mb-1">Storefront URL</label>
                  <div className="flex items-center gap-2">
                    <input aria-label="Storefront URL" id="page-storefront-url-27"
                      type="text"
                      readOnly
                    ...
                    <button type="button" onClick={() =>
                      ...
                      className="p-2 bg-gray-950 text-white rounded-lg hover:bg-gray-800 transition"
                    >
                      {copied === "storefront" ? <CheckCircle className="size-5" /> : <Copy className="size-5" />}
                    </button>
                  </div>
                </div>

                <div>
                  <label htmlFor="page-referral-code-28" className="text-sm text-gray-500 block mb-1">Referral Code</label>
                  <div className="flex items-center gap-2">
                    <input aria-label="Referral Code" id="page-referral-code-28"
                      type="text"
                      readOnly
                      value={`?ref=${currentInfluencer.username}`}
                      className="flex-1 px-4 py-2 bg-gray-50 border rounded-lg text-sm"
                    />
                    <button aria-label="check circle" type="button" onClick={() => copyToClipboard(`?ref=${currentInfluencer.username}`, "ref")}
                      className="p-2 bg-gray-950 text-white rounded-lg hover:bg-gray-800 transition"
                    >
                      {copied === "ref" ? <CheckCircle className="size-5" /> : <Copy className="size-5" />}
                    </button>
                  </div>
                  <p className="text-xs text-gray-500 mt-1">
                ...
                {currentInfluencer.curatedProducts.slice(0, 10).map((productId) => {
                  ...
                  return (
                    <div key={productId} className="p-4 flex items-center gap-4">
                      ...
                      <button type="button" onClick={() => copyToClipboard(link, productId)}
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-100">
              <h3 className="font-medium mb-3 flex items-center gap-2">
                <Lightning className="size-5 text-purple-600" />
                Tips to Boost Your Sales
              </h3>
              <ul className="space-y-2 text-sm text-gray-700">
                <li className="flex items-start gap-2">
                  <CheckCircle className="size-4 text-purple-600 mt-0.5" />

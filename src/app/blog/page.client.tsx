        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="relative max-w-md mx-auto">
              <MagnifyingGlass className="absolute left-4 top-1/2 -translate-y-1/2 size-5 text-gray-500" />
      ...
      <div className="container mx-auto px-4 py-12">
        {loading ? (
          <div className="text-center py-20">
            <SpinnerGap className="size-8 animate-spin text-gray-400 mx-auto mb-4" />
                ...
                <Link href={`/blog/${featuredPost.slug}`} className="group block">
                  <div className="grid md:grid-cols-2 gap-8 items-center">
                    <div className="relative aspect-[4/3] overflow-hidden bg-gray-100">
                      ...
                      <div className="absolute top-4 left-4 px-3 py-1 bg-gray-950 text-white text-xs tracking-wider">
                        FEATURED
                      </div>
                    </div>
                    <div className="py-4">
      ...
      <section className="bg-gray-100 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <form className="flex gap-3 max-w-md mx-auto">
            ...
            <button
              type="submit"
              className="px-6 py-3 bg-gray-950 text-white text-sm tracking-wider hover:bg-gray-800 transition flex items-center gap-2"
            >

          ...
          <AnimatePresence mode="wait">
            ...
            {mode === "login" && (
              ...
              >
                ...
                <form onSubmit={handleLogin} className="space-y-5">
                  <div>
                    <label htmlFor="login-email" className="block text-sm font-bold mb-2 text-gray-700">Email Address</label>
                    <div className="relative">
                      <Envelope className="absolute left-4 top-1/2 -translate-y-1/2 size-5 text-gray-400" />
                      <input
                        id="login-email"
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-gray-950 text-white py-4 rounded-xl font-bold text-lg hover:bg-gray-800 transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {loading ? (
                      <>
                        <SpinnerGap className="size-5 animate-spin" /> Signing In…
                      </>
                    ) : (
                      "Sign In"
                    )}
            ...
            {mode === "register" && (
              ...
              >
                ...
                <form onSubmit={handleRegister} className="space-y-5">
                  <div>
                    <label htmlFor="register-name" className="block text-sm font-bold mb-2 text-gray-700">Full Name</label>
                    <div className="relative">
                  ...
                  <div>
                    <label htmlFor="register-email" className="block text-sm font-bold mb-2 text-gray-700">Email Address</label>
                    <div className="relative">
                      <Envelope className="absolute left-4 top-1/2 -translate-y-1/2 size-5 text-gray-400" />
                  ...
                  <div>
                    <label htmlFor="register-password" className="block text-sm font-bold mb-2 text-gray-700">Password</label>
                    <div className="relative">
                      <Lock className="absolute left-4 top-1/2 -translate-y-1/2 size-5 text-gray-400" />
                  ...
                  >
                    {loading ? (
                      <>
                        <SpinnerGap className="size-5 animate-spin" /> Creating Account…
                      </>
                    ) : (
                      "Create Account"
                    )}
            ...
            {mode === "forgot" && (
              <motion.div
                ...
                exit={{ opacity: 0, x: -20 }}
              >
                <button aria-label="arrow left" type="button" onClick={() => switchMode("login")}
                ...
                <form onSubmit={handleForgotPassword} className="space-y-5">
                  <div>
                    <label htmlFor="forgot-email" className="block text-sm font-bold mb-2 text-gray-700">Email Address</label>
                    <div className="relative">
                      <Envelope className="absolute left-4 top-1/2 -translate-y-1/2 size-5 text-gray-400" />
                      <input aria-label="Email Address"
                        id="forgot-email"
                  ...
                  >
                    {loading ? (
                      <>
                        <SpinnerGap className="size-5 animate-spin" />Sending…</>
                    ) : (
                      "Send Reset Link"
                    )}
                  </button>

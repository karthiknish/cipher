      ...
      <div className="container mx-auto px-4 py-16">
        {activeContests.length === 0 && closedContests.length === 0 ? (
          <div className="text-center py-20">
            <Users className="size-12 mx-auto text-gray-300 mb-4" />
                      ...
                      >
                          ...
                          >
                            <div className={`border-2 transition-all duration-300 ${
                              ...
                              <div className="aspect-[4/5] relative bg-gray-50 overflow-hidden">
                                ...
                                <AnimatePresence>
                                  {votingAnimation === contest.id && selectedDesign[contest.id] === "A" && (
                                    ...
                                    >
                                      ...
                                      >
                                        <Confetti className="size-16" weight="fill" />
                                      </motion.div>
                                    </motion.div>
                                  )}
                                </AnimatePresence>
                                ...
                                {/* Hover Overlay */}
                                {!hasVoted && (
                                  <div className={`absolute inset-0 bg-gray-950/40 flex items-center justify-center transition-opacity duration-300 ${
                        ...
                        {!user && (
                          <div className="text-center mt-8">
                            <Link
                              href="/login"
                              className="inline-flex items-center gap-2 text-sm tracking-wider bg-gray-950 text-white px-8 py-3 hover:bg-gray-900 transition-colors"
                            >
                              LOGIN TO VOTE
                            </Link>
                          </div>
                      ...
                      >
                        ...
                        <div className="p-4">
                          ...
                          <div className="flex gap-1">
                            <div className="h-2 bg-gray-950 rounded-l" style={{ width: `${stats.percentA}%` }} />

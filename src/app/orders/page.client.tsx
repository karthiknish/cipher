    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 py-12">
        {orders.length === 0 ? (
          ...
          >
            <div className="size-20 bg-gray-100 mx-auto mb-6 flex items-center justify-center">
              ...
              >
                ...
                <div className="space-y-4 mb-6">
                  {order.items.slice(0, 3).map((item) => (
                    <div key={`${item.name}-${item.size}`} className="flex gap-4">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <Link
                    ...
                    className="flex-1 flex items-center justify-center gap-2 border border-black py-3 text-sm tracking-wider font-medium hover:bg-gray-950 hover:text-white transition"
                  >
                    VIEW DETAILS <CaretRight className="size-4" />
                  </Link>
                  {order.status === "delivered" && (
                    <button type="button" className="flex-1 bg-gray-950 text-white py-3 text-sm tracking-wider font-medium hover:bg-gray-900 transition">
                      BUY AGAIN
                    </button>
                  )}
                </div>

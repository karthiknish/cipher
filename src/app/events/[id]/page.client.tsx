            ...
            <div className="grid sm:grid-cols-2 gap-6">
              ...
              <div className="bg-gray-50 p-6">
                <div className="flex items-center gap-3 mb-3">
                  <Calendar weight="fill" className="size-5 text-gray-400" />
              ...
              <div className="bg-gray-50 p-6">
                <div className="flex items-center gap-3 mb-3">
                  <Clock weight="fill" className="size-5 text-gray-400" />
            ...
            <div className="bg-gray-50 p-6">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  <MapPin weight="fill" className="size-5 text-gray-400" />
              ...
              <div className="bg-gray-50 p-6">
                  ...
                  <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
                    <div 
                      className={`h-full transition-all ${
                        capacityPercent >= 90 ? "bg-red-500" : capacityPercent >= 70 ? "bg-yellow-500" : "bg-gray-950"
                      }`}
                ...
                {!eligibility.eligible && !isRSVPd && (
                  <div className="flex items-start gap-3 p-3 bg-yellow-50 border border-yellow-200 mb-4">
                    <Warning className="size-5 text-yellow-600 flex-shrink-0" />
                ...
                {/* Share Button */}
                <button aria-label="share" type="button" onClick={handleShare}
                ...
                <ul className="space-y-3 text-sm">
                  {event.type === "popup" && (
                    <>
                      ...
                      <li className="flex items-center gap-3">
                        <Lightning className="size-4 text-gray-400" />

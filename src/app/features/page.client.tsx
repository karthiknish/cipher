                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm mb-6">
                                <Lightning className="size-4 text-yellow-400" weight="fill" />
                        ...
                        >
                            <div className="relative aspect-square max-w-lg ml-auto">
                                {/* Decorative elements */}
                                <div className="absolute -top-4 -left-4 size-24 border border-white/20" />
                                <div className="absolute -bottom-4 -right-4 size-32 bg-white/5" />

                                {/* Main image */}
                                <div className="relative size-full bg-white/5 overflow-hidden">
                                    <Image
                                    ...
                                    <motion.div
                                        ...
                                        animate={{ opacity: 1, y: 0 }}
                                        transition={{ delay: 1 }}
                                        className="absolute bottom-6 left-6 bg-gray-950/90 text-white px-4 py-3 backdrop-blur-sm"
                                    >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 gap-4 auto-rows-[180px]">
                            ...
                            <div className="relative z-10 h-full flex flex-col justify-between">
                                <div>
                                    <div className="size-14 bg-white/10 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                                        <Brain className="size-7 text-white" weight="bold" />
                                    </div>
                        ...
                        >
                            <div className="flex items-center gap-4 h-full">
                                <div className="size-12 bg-gray-950 flex items-center justify-center group-hover:scale-110 transition-transform">
                                    <MagicWand className="size-6 text-white" weight="bold" />
                                </div>
                                <div>
                        ...
                        >
                            <div className="flex items-center gap-4 h-full">
                                <div className="size-12 bg-gray-950 flex items-center justify-center group-hover:scale-110 transition-transform">
                                    <Ruler className="size-6 text-white" weight="bold" />
                                </div>
                                <div>
                            ...
                            <div className="h-full flex flex-col justify-between">
                                <div>
                                    <div className="size-12 bg-white/10 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                                        <Trophy className="size-6 text-yellow-400" weight="bold" />
                                    </div>
                        ...
                        >
                            <div className="flex items-center gap-4">
                                <div className="size-10 bg-gray-950 flex items-center justify-center group-hover:scale-110 transition-transform">
                                    <Scales className="size-5 text-white" weight="bold" />
                                </div>
                                <div>
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-4">
                                    <div className="size-12 bg-white/10 flex items-center justify-center group-hover:scale-110 transition-transform">
                                        <Cube className="size-6 text-white" weight="bold" />
                                    </div>
                                    <div>
                                ...
                                {FEATURES.personalization.map((feature) => (
                                    ...
                                    >
                                        <div className="flex items-start gap-3">
                                            <div className="size-10 bg-gray-100 flex items-center justify-center group-hover:bg-gray-950 group-hover:text-white transition-colors">
                                            ...
                                            <div className="flex-1">
                                                <div className="flex items-center gap-2 mb-1">
                                                    ...
                                                    {feature.isNew && (
                                                        <span className="px-1.5 py-0.5 bg-gray-950 text-white text-[9px] font-bold">NEW</span>
                                                    )}
                                                </div>
            ...
            <section className="py-24 px-6 bg-gray-950 text-white">
                <div className="max-w-4xl mx-auto text-center">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <Sparkle className="size-12 mx-auto mb-6 text-yellow-400" weight="fill" />

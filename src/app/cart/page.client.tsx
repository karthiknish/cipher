        ...
        <div className="grid lg:grid-cols-3 gap-12">
                ...
                >
                  ...
                  <div className="col-span-4 md:col-span-2 flex items-center justify-center">
                    <div className="flex items-center border border-gray-200">
                      <button aria-label="minus" type="button" onClick={() => updateQuantity(item.id, item.size, item.quantity - 1)}
                        className="p-2 hover:bg-gray-50 transition"
                      >
                        <Minus className="size-3" />
                      </button>
                      <span className="px-4 text-sm">{item.quantity}</span>
                      <button aria-label="plus" type="button" onClick={() => updateQuantity(item.id, item.size, item.quantity + 1)}
                        className="p-2 hover:bg-gray-50 transition"
                      >
          ...
          >
            <div className="bg-neutral-50 p-8 sticky top-24">
              ...
              <Link 
                href="/checkout"
                className="block w-full bg-gray-950 text-white py-4 text-sm tracking-wider font-medium hover:bg-gray-900 transition text-center mb-4"
              >
                CHECKOUT
              </Link>

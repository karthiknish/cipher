...
const SHOWCASE_ITEMS = [
  { id: 1, product: "Street Tee" },
  { id: 2, product: "Cipher Hoodie" },
  { id: 3, product: "Tech Jacket" },
];
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="relative">
              {/* Main card */}
              <div className="relative aspect-[4/5] bg-white/5 rounded-3xl border border-white/10 overflow-hidden">
                {/* Phone mockup frame */}
                <div className="absolute inset-4 bg-neutral-900 rounded-2xl overflow-hidden border border-white/5">
                  {/* Screen content */}
                  <div className="h-full flex flex-col">
                    ...
                    {/* Main visual area */}
                    <div className="flex-1 relative bg-neutral-800 m-2 rounded-xl overflow-hidden">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="relative">
                          ...
                          <AnimatePresence mode="wait">
                            ...
                            >
                              <div className="w-28 h-32 bg-white/20 rounded-lg blur-sm" />
                            </motion.div>
                          </AnimatePresence>
                        </div>
                      </div>
                      ...
                      <motion.div
                        ...
                        className="absolute inset-x-0 h-1 bg-white/30"
                      />
